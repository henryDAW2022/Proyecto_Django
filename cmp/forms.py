...
class ProveedorForm(forms.ModelForm):
    ...
    class Meta:
        model=Proveedor
        exclude = ['um','fm','uc','fc'] ##Directamente solo excluimos
...
class ComprasEncForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['fecha_compra'].widget.attrs['readonly'] = True   ## sobreescribimos para que no sean editables estos campos.
